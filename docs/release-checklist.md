...
- [ ] **利用規約 / プライバシーポリシー** 文面 + In-app About 画面リンク
  - 個人開発でも提出時に URL 必須 (Apple App Privacy, Google Data safety)
  - リポジトリの GitHub Pages or 静的ホスティングで公開
- [ ] **About 画面** (Settings から遷移) — 利用規約 / プライバシーポリシー / ライセンス情報を表示
...
- [ ] **アプリ名** — "Kanji Builder" (日本語の英語表記でも OK)
- [ ] **キャッチコピー / 短い説明** (1 行)
- [ ] **アプリ説明文** (日本語 + 英語、各 300〜2,000 字)
- [ ] **キーワード** — 検索でヒットしてほしい単語 (JLPT / 漢字 / kanji / Japanese learn など)
- [ ] **カテゴリ** — 教育 (Education) / 単語ゲーム
- [ ] **対象年齢** — 4+ / Everyone (アプリ内に問題のあるコンテンツなし)
- [ ] **連絡先メールアドレス** (サポート用)
- [ ] **利用規約 URL** — 公開済みの 2 番セクション参照
- [ ] **プライバシーポリシー URL** — 同上
