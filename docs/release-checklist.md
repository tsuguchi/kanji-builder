...
- [ ] **GitHub Pages 有効化** — 上記文面をストア提出可能な URL で公開
  - 公開後 URL: `https://tsuguchi.github.io/kanji-builder/terms`, `.../privacy`
  - 手順: 4. ストア提出書類 — 共通 セクション末尾の「GitHub Pages 公開手順」を参照
...
- [ ] **利用規約 URL** — `https://tsuguchi.github.io/kanji-builder/terms` _(下の Pages 公開手順を完了後に確定)_
- [ ] **プライバシーポリシー URL** — `https://tsuguchi.github.io/kanji-builder/privacy` _(同上)_
...
| 利用規約 / プライバシーポリシー 公開 URL      | yes  | ⏳ GitHub Pages 待ち |
